...
export default function setOption(option = {}) {
  ...
  if (this.option) {
    ...
    this.option = {
      ...
      timelineVisible: option.timelineVisible === undefined ?
        this.option.timelineVisible : option.timelineVisible,
      showDepth: option.showDepth === undefined ?
        this.option.showDepth : option.showDepth,
    ...
    this.option = {
      ...
      timeFilter: option.timeFilter ||
        (t => new Date(t * 1000).toString('M/d/yyyy')),
      overTimeFilter: option.overTimeFilter ||
        (t => new Date(t * 1000).toString('M/d/yyyy')),
...
function init() {
  ...
  this.colors = {
    ...
    // background: colors.background || (isDarkTheme ? '#fff' : '#ebf5fa'),
    ...
    matrixColor: colors.matrixColor ||
      (isDarkTheme ? 'rgb(234, 177, 103)' : 'rgb(234, 177, 103)'),
    trixColor: colors.trixColor ||
      (isDarkTheme ? 'rgb(166, 206, 227)' : 'rgb(59, 187, 59)'),
    arColor: colors.arColor ||
      (isDarkTheme ? 'rgb(234, 177, 103)' : 'rgb(234, 177, 103)'),
    brColor: colors.brColor ||
      (isDarkTheme ? 'rgb(166, 206, 227)' : 'rgb(59, 187, 59)'),
    vrColor: colors.vrColor ||
      (isDarkTheme ? 'rgb(234, 177, 103)' : 'rgb(234, 177, 103)'),
    mavrColor: colors.mavrColor ||
      (isDarkTheme ? 'rgb(166, 206, 227)' : 'rgb(59, 187, 59)'),
    obvColor: colors.obvColor ||
      (isDarkTheme ? 'rgb(234, 177, 103)' : 'rgb(234, 177, 103)'),
    maobvColor: colors.maobvColor ||
      (isDarkTheme ? 'rgb(166, 206, 227)' : 'rgb(59, 187, 59)'),
    rsi6Color: colors.kColor ||
      (isDarkTheme ? 'rgb(234, 177, 103)' : 'rgb(234, 177, 103)'),
    rsi12Color: colors.dColor ||
      (isDarkTheme ? 'rgb(166, 206, 227)' : 'rgb(59, 187, 59)'),
    rsi24Color: colors.jColor ||
      (isDarkTheme ? 'rgb(208, 146, 209)' : 'rgb(208, 146, 209)')
  };
